...
import CareSlider from "@/components/slider/care-slider";
...
export default async function CareSection() {
  ...
  return (
    <section className="py-[50px] lg:py-[100px] 2xl:py-[150px]">
      {/* Header */}
      <div className="mx-auto flex max-w-[1480px] flex-col items-center gap-[30px] px-2.5 sm:gap-[50px] lg:px-5 2xl:px-10">
      ...
      <div className="mx-auto mt-[30px] max-w-[1480px] sm:mt-[50px] lg:mt-[70px] lg:px-5 2xl:mt-[100px] 2xl:px-10">
        <CareSlider
          cards={careCards as unknown as { image: string; alt: string; textKey: string }[]}
          texts={texts}
          feedLabel={t("feed")}
        />
      </div>
      ...
      <div className="mx-auto mt-[80px] sm:mt-[100px] 2xl:mt-[150px]">
        <Image
