...
import PetsSlider from "@/components/slider/pets-slider";
...
export default async function PetsSection() {
  ...
  return (
    <section className="py-[50px] xl:py-[100px] 2xl:py-[150px]">
      {/* Header */}
      <div className="mx-auto flex max-w-[1480px] flex-col items-center gap-[30px] px-2.5 sm:gap-[50px] lg:px-5 xl:gap-[50px] 2xl:px-10">
