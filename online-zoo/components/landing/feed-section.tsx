            ...
            <div key={step.number}>
              ...
              <div className="flex flex-col items-center gap-[20px] text-center sm:gap-[30px] xl:flex-row xl:items-start xl:gap-[40px] xl:text-left">
                ...
                <div className="flex flex-col items-center xl:items-start">
                  ...
                  {step.number === "03" && (
                    <button className="mt-[30px] flex w-full cursor-pointer items-center justify-center gap-2.5 rounded-[5px] bg-orange p-[11.5px] text-lg font-semibold uppercase text-white transition-all duration-300 hover:bg-orange-hover hover:shadow-[0_4px_30px_0_rgba(245,128,33,0.3)] active:scale-[1.03] sm:mt-[50px] sm:w-[240px] sm:p-[26px]">
